function RegularExpressions()
        {
            ...
            // var right=`<i class="fas fa-check-circle"></i>`


            //uname  
            if(uname.value==undefined || uname.value=="")
            {
                uname_err.innerHTML=`${wrong} Enter username`
            ...
            {
                email_err.innerHTML=`<i class="bi bi-patch-exclamation-fill"></i> must be name@domain.extention only`
                email.style.border="#f52525 solid"
            ...
            {
                pwd_err.innerHTML=`<i class="bi bi-patch-exclamation-fill"></i> must be 1 Uppercase,1 Lowercase 1 special character`
                pwd.style.border="#f52525 solid"
